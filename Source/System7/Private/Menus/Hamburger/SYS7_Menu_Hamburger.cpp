...
#include "Menus/Hamburger/SYS7_Menu_Hamburger_Expanded.h"
/*-------------------------------------------------------------------------*/
...
/*   Functions                                                             */
/*-------------------------------------------------------------------------*/
#pragma region SYS7_Menu_Hamburger.cpp_Functions
void USYS7_Menu_Hamburger::NativePreConstruct()
{
...
void USYS7_Menu_Hamburger::NativeConstruct()
{
...
void USYS7_Menu_Hamburger::FinalizeCollapse()
{
	WidgetSwitcher->SetActiveWidget(Menu_Collapsed);
}

void USYS7_Menu_Hamburger::NativeOnRemovedFromFocusPath(const FFocusEvent& InFocusEvent)
{
	Super::NativeOnRemovedFromFocusPath(InFocusEvent);
	Collapse();
}

void USYS7_Menu_Hamburger::BindButtons()
{
...
void USYS7_Menu_Hamburger::InitializeButtons()
{
...
void USYS7_Menu_Hamburger::Expand()
{
...
void USYS7_Menu_Hamburger::Collapse()
{
	if (!bIsExpanded) return;
...
void USYS7_Menu_Hamburger::HandleSelectionButtonClicked(ESYS7_Menu_Hamburger_Selection NewSelection)
{
...
void USYS7_Menu_Hamburger::UpdateActiveSelectionText(ESYS7_Menu_Hamburger_Selection NewSelection) const
{
	if (NewSelection == ESYS7_Menu_Hamburger_Selection::Selection1)
	{
		const FText ActiveSelectionText = Menu_Expanded->Button_Selection1->GetText();
		Button_Hamburger->SetText(ActiveSelectionText);
	} else if (NewSelection == ESYS7_Menu_Hamburger_Selection::Selection2)
	{
		const FText ActiveSelectionText = Menu_Expanded->Button_Selection2->GetText();
		Button_Hamburger->SetText(ActiveSelectionText);
	} else if (NewSelection == ESYS7_Menu_Hamburger_Selection::Selection3)
	{
		const FText ActiveSelectionText = Menu_Expanded->Button_Selection3->GetText();
		Button_Hamburger->SetText(ActiveSelectionText);
	} else if (NewSelection == ESYS7_Menu_Hamburger_Selection::Selection4)
	{
		const FText ActiveSelectionText = Menu_Expanded->Button_Selection4->GetText();
		Button_Hamburger->SetText(ActiveSelectionText);
	} else if (NewSelection == ESYS7_Menu_Hamburger_Selection::Selection5)
	{
