...
/*   Functions                                                             */
/*-------------------------------------------------------------------------*/
#pragma region SYS7_Menu_Hamburger_Expanded.cpp_Functions
void USYS7_Menu_Hamburger_Expanded::PlayExpandedAnimation()
{
	if (DelayTime <= 0) return;
	
	for (int32 i = 0; i < SelectionButtons.Num(); i++)
	{
		USYS7_Button_Wide* Button = SelectionButtons[i];
...
void USYS7_Menu_Hamburger_Expanded::PlayCollapsedAnimation()
{
	if (DelayTime <= 0) return;
...
void USYS7_Menu_Hamburger_Expanded::ClearAnimations()
{
	for (int32 i = 0; i < SelectionButtons.Num(); i++)
	{
		USYS7_Button_Wide* Button = SelectionButtons[i];
...
void USYS7_Menu_Hamburger_Expanded::ClearWidgetOpacity()
{
	for (int32 i = 0; i < SelectionButtons.Num(); i++)
	{
		USYS7_Button_Wide* Button = SelectionButtons[i];
...
void USYS7_Menu_Hamburger_Expanded::NativeConstruct()
{
...
void USYS7_Menu_Hamburger_Expanded::NativeOnFocusLost(const FFocusEvent& InFocusEvent)
{
