...
#include "SYS7_Button_Wide.generated.h"
/*-------------------------------------------------------------------------*/
...
/*   Declarations                                                          */
/*-------------------------------------------------------------------------*/
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FSYS7_Button_Wide_OnClickedEvent);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FSYS7_Button_Wide_OnPressedEvent);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FSYS7_Button_Wide_OnReleasedEvent);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FSYS7_Button_Wide_OnHoverEvent);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FSYS7_Button_Wide_OnIsEnabledEvent, bool, bIsEnabled);
class UButton;
class UTextBlock;
/*-------------------------------------------------------------------------*/
...
/*   Class Functionality                                                   */
/*-------------------------------------------------------------------------*/
#pragma region SYS7_Button_Wide.h_Class
UCLASS()
class SYSTEM7_API USYS7_Button_Wide : public USYS7_Widget
{
    GENERATED_BODY()
...
public:
    ...
    UPROPERTY(BlueprintAssignable, Category = "SYS7_Button|Event")
    FSYS7_Button_Wide_OnReleasedEvent OnReleased;

    UPROPERTY(BlueprintAssignable, Category = "SYS7_Button|Event")
    FSYS7_Button_Wide_OnHoverEvent OnHovered;

    UPROPERTY(BlueprintAssignable, Category = "SYS7_Button|Event")
    FSYS7_Button_Wide_OnHoverEvent OnUnhovered;

    UPROPERTY(BlueprintAssignable, Category = "SYS7_Button|Event")
    FSYS7_Button_Wide_OnIsEnabledEvent OnIsEnabled;
    ...
    /* SYS7 Button can operate as a TextBlock if it implements the optional text block bindings. */
    UFUNCTION(BlueprintCallable, Category = "SYS7_Button")
