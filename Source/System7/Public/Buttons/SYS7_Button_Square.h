...
#include "SYS7_Button_Square.generated.h"
/*-------------------------------------------------------------------------*/
...
/*   Declarations                                                          */
/*-------------------------------------------------------------------------*/
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FSYS7_Button_Square_OnClickedEvent);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FSYS7_Button_Square_OnPressedEvent);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FSYS7_Button_Square_OnReleasedEvent);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FSYS7_Button_Square_OnHoverEvent);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FSYS7_Button_Square_OnIsEnabledEvent, bool, bIsEnabled);
class UButton;
class UImage;
/*-------------------------------------------------------------------------*/
...
/*   Class Functionality                                                   */
/*-------------------------------------------------------------------------*/
#pragma region SYS7_Button_Square.h_Class
UCLASS()
class SYSTEM7_API USYS7_Button_Square : public USYS7_Widget
{
	GENERATED_BODY()
...
public:
    ...
    FSYS7_Button_Square_OnClickedEvent OnClicked;

    /* Instead of OnClicked, you'd rather use this  */
    UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "SYS7_Button|Event")
    FSYS7_Button_Square_OnClickedEvent OnClickedPostAnim;
    
    UPROPERTY(BlueprintAssignable, Category = "SYS7_Button|Event")
    FSYS7_Button_Square_OnPressedEvent OnPressed;
    
    UPROPERTY(BlueprintAssignable, Category = "SYS7_Button|Event")
    FSYS7_Button_Square_OnReleasedEvent OnReleased;

    UPROPERTY(BlueprintAssignable, Category = "SYS7_Button|Event")
    FSYS7_Button_Square_OnHoverEvent OnHovered;

    UPROPERTY(BlueprintAssignable, Category = "SYS7_Button|Event")
    FSYS7_Button_Square_OnHoverEvent OnUnhovered;

    UPROPERTY(BlueprintAssignable, Category = "SYS7_Button|Event")
    FSYS7_Button_Square_OnIsEnabledEvent OnIsEnabled;
    
    UPROPERTY(meta = (BindWidget))
    TObjectPtr<UButton> UE_Button;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SYS7_Button|Defaults")
    ...
    UFUNCTION(BlueprintCallable, Category = "SYS7_Button")
