...
/*   Declarations                                                          */
/*-------------------------------------------------------------------------*/
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FCUI_Button_CircleTick_OnCheckStateChangedEvent, bool, bIsChecked);
class UCheckBox;
/*-------------------------------------------------------------------------*/
...
public:
	...
	FCUI_Button_CircleTick_OnCheckStateChangedEvent OnCheckStateChanged;
